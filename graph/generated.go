...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateQuestion":
		...
		return e.complexity.Mutation.UpdateQuestion(childComplexity, args["id"].(string), args["input"].(model.QuestionInput)), true
...
func (ec *executionContext) _Mutation_updateQuestion(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateQuestion(rctx, fc.Args["id"].(string), fc.Args["input"].(model.QuestionInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
